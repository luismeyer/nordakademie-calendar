...
const SECRETS_PATH = path.resolve(__dirname, "../secrets/secrets.json.gpg");
const MEETINGS_PATH = path.resolve(__dirname, "../secrets/meetings.json.gpg");
...
start()
  .then(decryptFilePath(MEETINGS_PATH, MEETINGS_OUTPUT))
